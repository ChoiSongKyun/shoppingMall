		...
		<div class="row">
				...
				<table class="table" style="margin-top: 0;">
					...
					<tbody>
						...
						<tr style="height: 70px; background-color: #f7f7f7">
							...
							<td colspan="5"
								style="text-align: right; vertical-align: middle;">상품구매금액 <span
								name="pprice">${p}</span> won + 배송비 0(무료)=합계:<span>총가격</span>
								won &nbsp;
							</td>
			...
			<div class="col-sm-12" style="margin-bottom: 20px; text-align: center;" align="right">
				...
				<a href="#" class="btn btn-default btn-default"
					...
					<a href="/shop/home.do?cmd=home" class="btn btn-default" style="width: 150px; text-align: center; right: 0;position: absolute;">쇼핑계속하기</a>
